Objetivo:
Crie um teste de soak com K6 para registrar um usuário, fazer login dele e realizar o checkout.
...
Definicao: 
Testes de soak são testes que descubrem se e quando o sistema se degrada sob cargas de maior duração.
