Objetivo:
Crie um teste de stress com K6 para registrar um usuário, fazer login dele e realizar o checkout.
...
Regras:
- Salve o teste dentro da pasta test/k6/checkout-stressu.test.js
...
Definicao: 
Testes de stress são testes que avaliam o desempenho do sistema quando a carga de trabalho é mais pesada que o normal. 